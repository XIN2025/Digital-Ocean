...
export default function Home() {
  ...
  return (
    <div className="sm:max-w-3xl px-12   mx-auto flex h-[100vh] flex-col items-center justify-center">
      <Header />
      <main className="flex justify-center h-full items-center flex-1  ">
